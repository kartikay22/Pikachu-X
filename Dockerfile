...
#Import Gudz
RUN wget  https://raw.githubusercontent.com/Kartikay22/PIKACHU-X/master/Pikachubotrun.py
RUN wget https://raw.githubusercontent.com/Kartikay22/PIKACHU-X/master/requirements.txt
#Start Fumkin
RUN pip3 install -r requirements.txt

CMD ["python3","Pikachubotrun.py"]
